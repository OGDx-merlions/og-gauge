...
function runBaseTests() {
  og_gauge_1 = document.getElementById('og_gauge_1');

  suite('Base Automation Tests for og-gauge', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('og-gauge fixture is created', function() {
      assert.isTrue(document.getElementById('og_gauge_1') !== null);
    });
